...
#define GTK_MENU_TRACKER_ITEM(inst)          (G_TYPE_CHECK_INSTANCE_CAST ((inst), GTK_TYPE_MENU_TRACKER_ITEM, GtkMenuTrackerItem))
#define GTK_IS_MENU_TRACKER_ITEM(inst)       (G_TYPE_CHECK_INSTANCE_TYPE ((inst), GTK_TYPE_MENU_TRACKER_ITEM))
...
gboolean               gtk_menu_tracker_item_get_has_link              (GtkMenuTrackerItem *self, const char *link_name);
...
GMenuModel*           _gtk_menu_tracker_item_get_link                  (GtkMenuTrackerItem *self, const char *link_name);
...
void                   gtk_menu_tracker_item_request_submenu_shown     (GtkMenuTrackerItem *self, gboolean shown);
