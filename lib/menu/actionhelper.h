...
void               gtk_action_helper_set_action_name           (GtkActionHelper *helper, const char *action_name);
void               gtk_action_helper_set_action_target_value   (GtkActionHelper *helper, GVariant *action_target);
