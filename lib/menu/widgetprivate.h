...
#include <gtk/gtk.h>
#include "sizerequestcacheprivate.h"
...
GtkActionMuxer*   _gtk_widget_get_action_muxer             (GtkWidget *widget, gboolean create);
...
GtkEventController **gtk_widget_list_controllers           (GtkWidget *widget, GtkPropagationPhase  phase, guint *out_n_controllers);
...
GtkActionMuxer* _gtk_widget_get_action_muxer (GtkWidget*, gboolean create);
GtkActionMuxer*  gtk_widget_get_parent_muxer (GtkWidget*, gboolean create);
