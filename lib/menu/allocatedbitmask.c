...
#include "allocatedbitmaskprivate.h"
...
void
_gtk_allocated_bitmask_print (const GtkBitmask *mask, GString *string)
{
...
GtkBitmask *
_gtk_allocated_bitmask_set (GtkBitmask *mask, guint index_, gboolean value)
{
  guint array_index, bit_index;
...
gboolean
_gtk_allocated_bitmask_equals (const GtkBitmask *mask, const GtkBitmask  *other)
{
  guint i;
...
gboolean
_gtk_allocated_bitmask_intersects (const GtkBitmask *mask, const GtkBitmask *other)
{
