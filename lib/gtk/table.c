...
static void
simple_table_get_property (GObject *object, guint prop_id, GValue *value, GParamSpec *pspec)
{
...
GtkWidget*
simple_table_new (guint	rows, guint	columns, gboolean homogeneous)
{
  GtkSimpleTable *table;
...
void
simple_table_forall (GtkWidget* container, gboolean include_internals, GtkCallback callback, gpointer callback_data)
{
  GtkSimpleTable *table = GTK_SIMPLE_TABLE (container);
  GtkSimpleTableChild *child;
  GList *children;
