...
const gchar* gdl_dock_object_nick_from_type    (GType);
GType        gdl_dock_object_type_from_nick    (const gchar*);
GType        gdl_dock_object_set_type_for_nick (const gchar*, GType);
