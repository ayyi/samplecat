...
struct _ViewIfaceClass {
	...
	void (*delete_if)(ViewIface *obj, gboolean (*test)(gpointer item, gpointer data), gpointer data);
	...
	void (*get_iter_at_point)(ViewIface *obj, ViewIter *iter, GdkWindow *src, int x, int y);
...
void view_delete_if(ViewIface *obj, gboolean (*test)(gpointer item, gpointer data), gpointer data);
...
void view_get_iter_at_point(ViewIface *obj, ViewIter *iter, GdkWindow *src, int x, int y);
