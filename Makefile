...
all: 
	gcc -Wall main.c support.c -o front $(PACKAGE_CFLAGS) $(PACKAGE_LIBS) -L/usr/local/lib/mysql -lmysqlclient -I/usr/include/gnome-vfs-2.0 -lgnomevfs-2 `pkg-config sndfile --cflags --libs` `pkg-config libart --cflags --libs`
