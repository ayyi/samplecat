...
void
_ad_dbus_marshal_VOID__STRING_INT (GClosure     *closure,
                                   GValue       *return_value,
...
void
_ad_dbus_marshal_VOID__INT_INT (GClosure     *closure,
                                GValue       *return_value,
                                guint         n_param_values,
                                const GValue *param_values,
                                gpointer      invocation_hint,
...
/* VOID:INT,INT,INT (dbus_marshallers.list:7) */
void
_ad_dbus_marshal_VOID__INT_INT_INT (GClosure     *closure,
                                    GValue       *return_value,
                                    guint         n_param_values,
                                    const GValue *param_values,
                                    gpointer      invocation_hint,
